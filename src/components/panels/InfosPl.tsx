	...
	return (
		<Panel title='Zasady gry' isOpen={isOpen} close={close}>
			<div className='space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3'>
				...
				<div>
					Po każdej próbie odgadnięcia otrzymasz informację o odległości, kierunku i bliskości między odgadniętym krajem
					a krajem docelowym.
				</div>
			</div>
			<div className='space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3'>
				...
				<div>
					...
					<div className='my-2'>
						...
						{formatDistance(13557000, settingsData.distanceUnit)} od kraju docelowego, kraj docelowy znajduje się w
						kierunku północno-wschodnim i masz tylko 32% bliskości, ponieważ jest ono dość daleko!
					</div>
				</div>
				<div>
					<Guesses
					...
					/>
					<div className='my-2'>
						Twój drugi typ <span className='uppercase font-bold'>Finlandia</span> jest bliżej!{' '}
						{formatDistance(3206000, settingsData.distanceUnit)} od kraju docelowego, w kierunku południowo-wschodnim i
						84% bliskości!
					</div>
				</div>
				<div>
			...
			<div className='space-y-3 text-justify pb-3'>
				...
				<div>
					...
					<a className='underline' href='https://www.ko-fi.com/teuteuf' target='_blank' rel='noopener noreferrer'>
						<Twemoji text='Postaw mi kawę! ☕' options={{ className: 'inline-block' }} />
					</a>
				</div>
			</div>
		</Panel>
